$(document).ready(function() {
    $('#form-aluno').validate({
        rules: {
            cpf: { required: true, minlength: 11, maxlength: 11 },
            ...
            cpf: { required: 'CPF é obrigatório.', minlength: 'Deve conter 14 dígitos.', maxlength: 'Deve conter 14 dígitos.' },
            nome: { required: 'Nome é obrigatório.', minlength: 'Mínimo de 3 dígitos.', maxlength: 'Máximo de 50 dígitos.' },
